...
set netlist ${proj_dir}/inputs/debuffered_netlist/${DESIGN}_debuffer.v
set sdc ${proj_dir}/inputs/netlist/${DESIGN}.sdc

source ${proj_dir}/scripts/invs_scripts/cadence/mmmc_setup.tcl
...
if { [info exists ::env(SEEDED_DEF)] && [file exists $::env(SEEDED_DEF)]} {
  ...
  puts "Seeded def does not exist. Running global place"
  exit
}
saveDesign $encDir/${DESIGN}_global_place.enc
